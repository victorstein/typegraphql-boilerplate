                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                            ...
                            <tr>
                              <td align="left">
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                  <tbody>
                                    <tr>
                                      <td> <a href="${PREFIX}${DOMAIN}${SHOW_PORT}/reset/${hash}" target="_blank">Reset password</a> </td>
                                    </tr>
                                  </tbody>
                                </table>
                              </td>
                        ...
                        <p><a href="${PREFIX}${DOMAIN}${SHOW_PORT}/reset/${hash}">${PREFIX}${DOMAIN}${SHOW_PORT}/reset/${hash}</a></p>
                      </td>
                    </tr>
                  </table>
                </td>
